...
export default function PredictionApp() {
  return (
    <div className="min-h-screen animated-bg bg-gradient-to-br from-primary/5 via-background to-accent/10">
      ...
      <footer className="border-t border-border/40 mt-12 md:mt-16 py-6 md:py-8 bg-gradient-to-r from-primary/5 via-secondary/5 to-accent/5 backdrop-blur-sm relative z-10">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm md:text-base text-foreground font-bold bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">
            DML-Predict AI © 2025
          </p>
          <p className="text-xs md:text-sm text-muted-foreground mt-2 max-w-2xl mx-auto">
            Sistema de apoyo al diagnóstico. No reemplaza el criterio médico profesional.
          </p>
          <p className="text-xs md:text-sm text-muted-foreground mt-3 flex items-center justify-center gap-2">
            Hecho con <span className="text-primary text-base md:text-lg animate-pulse">♥</span> por{" "}
            <span className="font-bold text-primary">Jbarcode</span>
          </p>
        </div>
      </footer>
    </div>
